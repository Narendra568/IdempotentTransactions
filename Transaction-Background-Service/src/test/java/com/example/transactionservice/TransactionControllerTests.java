...
public class TransactionControllerTests {
    ...
    public void testGetTransactionStatus_Success() throws Exception {
        TransactionResponse response = new TransactionResponse(123, "COMPLETED");

        when(transactionService.getTransactionStatus(123L)).thenReturn(response);
    ...
    public void testGetTransactionStatus_NotFound() throws Exception {
        when(transactionService.getTransactionStatus(999L)).thenThrow(new TransactionNotFoundException("Transaction not found"));
